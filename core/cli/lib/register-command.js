 ...
 */
 function registerCommand(argv) {
	...
	program
		...
		.option('-e, --eval-dir [dir]', 'sql script directory, relative to the current execution directory', 'sql')
		.option('-a, --host [host]', 'specify host name or IP address', 'localhost')
		.option('-t, --port [port]', 'specify the port number to try to connect to the MySQL server', '3306')
